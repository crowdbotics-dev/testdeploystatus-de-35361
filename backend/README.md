...
## Project Structure
    ...
    ├── testdeploystatus_de_35361  # Django project configurations
...
1. Clone this repo and `cd testdeploystatus_de_35361`
...
2. Clone this repo and `cd testdeploystatus_de_35361`
